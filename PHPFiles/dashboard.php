    ...
    <div class="sidebar">
        ...
        <ul class="menu">
            ...
            <li><a href="ApplicationsApplicant.html" class="menu-item"><img src="IMG/applications.png" alt="">My
                    Applications</a></li>
            <li><a href="MatchedJobsApplicatns.html" class="menu-item "><img src="IMG/searchicon.png" alt="">Matched
                    Jobs</a></li>
            <li><a href="SavedJobsApplicants.html" class="menu-item"><img src="IMG/saved.png" alt="">Saved Jobs</a></li>
            <li><a href="" class="menu-item"><img src="IMG/profile.png" alt="">My Public Profile</a></li>
